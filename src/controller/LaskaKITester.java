...
public class LaskaKITester {
	...
	public final static int MAX_MATCHES = 3; 		// Number of simultaneous matches (1 Match --> 2 Players --> 2 Threads)
	...
	public static void main(String[] args) {
        ...
        tc.addAi(new Player(SWIPL_PARAMETERS_AI1, 33, 101, 11, 11, 0, 0, 53));
        tc.addAi(new Player(SWIPL_PARAMETERS_AI1, 33, 101, 11, 3, 0, 29, 53));
        tc.addAi(new Player(SWIPL_PARAMETERS_AI1, 33, 101, 11, 3, 0, 53, 0));
